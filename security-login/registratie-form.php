...
<body class="web-backend-inleiding">
	...
	<form action="registratie-process.php" method="POST">
		<ul>
			...
			<li>
				<label for="paswoord">paswoord</label><input type="<?= ( isset($_SESSION['passwordGen']) ) ? 'text' : 'password' ?>" name="paswoord" value="<?= (isset($_SESSION['passwordGen']) ) ? $_SESSION['passwordGen'] : '' ?>"> <input type="submit" name="paswoordGeneratie" value="genereer een paswoord">
			</li>
			<li>
